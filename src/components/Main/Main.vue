<template>
  <div class="main" ref="mainWrapper">
    <div class="search container-fluid">
      <div class="serach_content">
        ...
        <div style="position: relative;">
          <input type="text" placeholder="美图等你来搜~" class="searchText">
          <input type="button" value="搜索ing" class="searchBtn hidden-xs">
          <input type="button" value="搜索ing" class="searchBtn visible-xs-block miniSearchBtn">
        </div>
        <p class="hidden-xs">
          <span>关键词：</span>
          <a href="https://cn.bing.com/images/search?q=人">人</a>
          <a href="https://cn.bing.com/images/search?q=城市">城市</a>
          <a href="https://cn.bing.com/images/search?q=自然">自然</a>
          <a href="https://cn.bing.com/images/search?q=游戏">游戏</a>
        </p>
        {{recommend}}
      </div>
    </div>
    <div class="imgContent container">
      ...
      <PhotoWalls :parent="'recommend'" v-show="recommend.length>0" ref="photowalls" :imgs="recommend" @show-shadow="showShadow" :userId="userId"></PhotoWalls>
    </div>
